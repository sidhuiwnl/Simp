<script>
	import { BoxIcon, HouseIcon, PanelsTopLeftIcon } from "@lucide/svelte"
              ...
              <span>
                <TabsTrigger value="tab-2" class="group py-3">
                  <span class="relative">
                    ...
                    <Badge class="border-background absolute -top-2.5 left-full min-w-4 -translate-x-1.5 px-0.5 text-[10px]/[.875rem] transition-opacity group-data-[state=inactive]:opacity-50">
                      3
                    </Badge>
                  </span>
                </TabsTrigger>
